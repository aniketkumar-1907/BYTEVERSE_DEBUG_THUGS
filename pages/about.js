...
const About = () => {
  return (
    ...
    <div className="about">
     ...
     <p>
     Blockchain technology, known for its secure, transparent, and tamper-proof capability popularised by its use in the crypto trade, is being studied in some places whether it can be used for voting in an election.
     <br/>
     <br/>
     <br/>
     <h3>Can Blockchain Make Voting More Transparent?</h3>
     <br/>
...
Rao further noted that one of the biggest advantages of blockchain voting is that it would help reduce the incidence of voter fraud. "Currently, there are many ways in which votes can be tampered with or manipulated. With blockchain, each vote would be recorded securely and could not be changed. This would make it much more difficult for anyone to rig the system," he said</p>

     </p>
     <br/>
     <h3>Are There Other Advantages?</h3>
     <br/>
     <p>Transparency through blockchain voting may also help increase the turnout. With blockchain, people would be able to see that their vote is being counted accurately and that their voice is being heard. This could lead to more people taking part in the democratic process.
<br/>
...
Experts believe that blockchain voting is still in its early stages, and there are many challenges that need to be addressed before it can be implemented nationwide</p>
    </div>
    </>
  )
}
